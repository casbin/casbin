...
- [Macaron](https://github.com/go-macaron/macaron): A high productive and modular web framework in Go, via plugin: [macaron-authz](https://github.com/casbin/macaron-authz)
