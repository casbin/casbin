...
- [VMware Dispatch](https://github.com/vmware/dispatch): A framework for deploying and managing serverless style applications, via direct integration, see: [model (in text)](https://github.com/vmware/dispatch/blob/master/pkg/identity-manager/handlers.go#L31-L40), [policy rules](https://github.com/vmware/dispatch/blob/master/pkg/identity-manager/testdata/test_policy.csv)
