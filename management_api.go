...
func (e *Enforcer) GetAllSubjects() []string {
	return e.model.GetValuesForFieldInPolicyAllPTypes("p", 0)
}
...
func (e *Enforcer) GetAllObjects() []string {
	return e.model.GetValuesForFieldInPolicyAllPTypes("p", 1)
}
...
func (e *Enforcer) GetAllActions() []string {
	return e.model.GetValuesForFieldInPolicyAllPTypes("p", 2)
}
...
func (e *Enforcer) GetAllRoles() []string {
	return e.model.GetValuesForFieldInPolicyAllPTypes("g", 1)
}
