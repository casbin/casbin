...
func TestRBACModelWithPattern(t *testing.T) {
	...
	e.rm.(*defaultrolemanager.RoleManager).AddMatchingFunc(util.KeyMatch2)
	...
	e.rm.(*defaultrolemanager.RoleManager).AddMatchingFunc(util.KeyMatch3)
...
func TestDomainMatchModel(t *testing.T) {
	...
	e.rm.(*defaultrolemanager.RoleManager).AddDomainMatchingFunc(util.KeyMatch2)
